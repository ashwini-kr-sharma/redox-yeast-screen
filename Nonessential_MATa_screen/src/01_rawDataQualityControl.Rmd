...
p1 = ggplot(tmpdat, aes(x = value, fill = Content)) + 
    ...
    labs(subtitle = "Non-essential MATa screen", 
...
p2 = ggplot(tmpdat[tmpdat$variable == "Signal_485_520",], 
            ...
            geom_density(alpha =0.5) + theme_bw(base_size = 8) + 
            labs(subtitle = "Non-essential MATa screen | Signal_485_520", 
                 x = "Fluorescence  signal (in log10)", 
                 y = "Density", fill = "") +
...
p3 = ggplot(tmpdat[tmpdat$variable == "Signal_400_520",],
            aes(x = value, fill = Content)) + 
            geom_density(alpha = 0.5) + theme_bw(base_size = 8) + 
            labs(subtitle = "Non-essential MATa screen | Signal_400_520", 
                 x = "Fluorescence  signal (in log10)", 
                 y = "Density", fill = "") +
...
ggsave(filename = paste0(path,"analysis/QC/background_fluorescence_Signal_485_520.pdf"), plot = p2, width = 7, height = 60, limitsize = F)
ggsave(filename = paste0(path,"analysis/QC/background_fluorescence_Signal_400_520.pdf"), plot = p3, width = 7, height = 60, limitsize = F)
...
saveRDS(rawDatCleaned, paste0(path,"data/workspaces/YeastRedox_MATa_RawData_ForZNorm.RDS"))
WriteXLS(rawDatCleaned, ExcelFileName = paste0(path,"analysis/supplementary/tables/YeastRedox_MATa_RawData_BackgroundFluorescence_Outliers_Filtered_ToUseForZnorm.xlsx"), 
AdjWidth =TRUE, BoldHeaderRow = TRUE, FreezeRow = 1)

# Raw data to be used for Control based normalization
saveRDS(rawDatCleaned_ctrlfilt, paste0(path,"data/workspaces/YeastRedox_MATa_RawData_ForCtrlNorm.RDS"))
WriteXLS(rawDatCleaned, ExcelFileName = paste0(path,"analysis/supplementary/tables/YeastRedox_MATa_RawData_BackgroundFluorescence_Outliers_PoorControl_Filtered_ToUseForCtrlNorm.xlsx"), 
AdjWidth =TRUE, BoldHeaderRow = TRUE, FreezeRow = 1)
