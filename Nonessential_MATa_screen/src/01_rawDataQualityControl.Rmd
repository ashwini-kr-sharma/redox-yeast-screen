...
```{r, eval = FALSE, echo = F, fig.width = 10, fig.height = 10, fig.align="center"}
...
```{r, eval = F, fig.width = 12, fig.height = 10, fig.align="center"}
...
```{r, eval = F, fig.width = 10, fig.height = 10, fig.align="center"}
...
paste0("Number of control genes removed which deviated (>2) from the plat median - ", length(rmv))
