...
{
  files = list.files(paste0(path,"data/plateReadings/", i), full.names=T)
...
WriteXLS(rawDat, ExcelFileName = paste0(path,"analysis/supplementary/tables/YeastMutantRedox_RawData.xlsx"), 
