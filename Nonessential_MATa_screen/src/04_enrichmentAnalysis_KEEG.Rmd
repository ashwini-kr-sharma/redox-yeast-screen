...
#normDat = readRDS(paste0(path,"data/workspaces/YeastMutantRedox_NormalizedData_PlateControl.RDS"))
...
```{r fig.width = 6.8, fig.height = 6.8, fig.align="center"}
...
pheatmap(
  ...
  annotation_row = anno_rows,
  annotation_colors = anno_color,
  filename = paste0(path, "analysis/enrichment/top_25percent_hits_KEGG_enrichment_hypergeometricTest.pdf"),
  width = 7, height = 7)
```
...
pheatmap(
  ...
  annotation_row = anno_rows,
  annotation_colors = anno_color,
  filename = paste0(path, "analysis/enrichment/top_25percent_hits_KEGG_Foldenrichment.pdf"),
  width = 7, height = 11)
...
pheatmap(
  ...
  annotation_row = anno_rows,
  annotation_colors = anno_color,
  filename = paste0(path, "analysis/enrichment/top_25percent_hits_KEGG_FractionOverlap.pdf"),
  width = 7, height = 11)
```
