...
pheatmap(
  ...
  annotation_row = anno_rows,
  annotation_colors = anno_color,
  filename = paste0(path, "analysis/enrichment/top_5percent_hits_KEGG_enrichment_hypergeometricTest.pdf"),
  width = 7, height = 7)
```
...
pheatmap(
  ...
  annotation_row = anno_rows,
  annotation_colors = anno_color,
  filename = paste0(path, "analysis/enrichment/top_5percent_hits_KEGG_Foldenrichment.pdf"),
  width = 7, height = 11)
...
pheatmap(
  ...
  annotation_row = anno_rows,
  annotation_colors = anno_color,
  filename = paste0(path, "analysis/enrichment/top_5percent_hits_KEGG_FractionOverlap.pdf"),
  width = 7, height = 11)
```
