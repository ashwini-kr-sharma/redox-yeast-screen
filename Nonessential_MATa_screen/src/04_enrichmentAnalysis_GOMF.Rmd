...
pheatmap(
  ...
  annotation_row = anno_rows,
  annotation_colors = anno_color,
  filename = paste0(path, "analysis/enrichment/top_25percent_hits_GOMF_enrichment_hypergeometricTest.pdf"),
  width = 6, height = 2.5)
```
...
pheatmap(
  ...
  annotation_row = anno_rows,
  annotation_colors = anno_color,
  filename = paste0(path, "analysis/enrichment/top_25percent_hits_GOMF_Foldenrichment.pdf"),
  width = 7, height = 7)
...
pheatmap(
  ...
  annotation_row = anno_rows,
  annotation_colors = anno_color,
  filename = paste0(path, "analysis/enrichment/top_25percent_hits_GOMF_FractionOverlap.pdf"),
  width = 7, height = 7)
```
