...
pheatmap(
  ...
  annotation_row = anno_rows,
  annotation_colors = anno_color,
  filename = paste0(path, "analysis/enrichment/top_25percent_hits_TFtargets_enrichment_hypergeometricTest.pdf"),
  width = 5, height = 3)
```
...
pheatmap(
  ...
  annotation_row = anno_rows,
  annotation_colors = anno_color,
  filename = paste0(path, "analysis/enrichment/top_25percent_hits_TFtargets_Foldenrichment.pdf"),
  width = 5, height = 15)
...
pheatmap(
  ...
  annotation_row = anno_rows,
  annotation_colors = anno_color,
  filename = paste0(path, "analysis/enrichment/top_25percent_hits_TFtargets_FractionOverlap.pdf"),
  width = 5, height = 15)
```
