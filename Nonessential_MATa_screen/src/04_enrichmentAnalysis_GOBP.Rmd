...
pheatmap(
  ...
  annotation_row = anno_rows,
  annotation_colors = anno_color,
  filename = paste0(path, "analysis/enrichment/top_5percent_hits_GOBP_enrichment_hypergeometricTest.pdf"),
  width = 7, height = 6)
```
...
pheatmap(
  ...
  annotation_row = anno_rows,
  annotation_colors = anno_color,
  filename = paste0(path, "analysis/enrichment/top_5percent_hits_GOBP_Foldenrichment.pdf"),
  width = 7, height = 11)
...
pheatmap(
  ...
  annotation_row = anno_rows,
  annotation_colors = anno_color,
  filename = paste0(path, "analysis/enrichment/top_5percent_hits_GOBP_FractionOverlap.pdf"),
  width = 7, height = 11)
```
