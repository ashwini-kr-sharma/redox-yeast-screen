...
if(!file.exists(paste0(path,"publicData/TF2DNA_2018.txt"))){
  download.file(url = "https://amp.pharm.mssm.edu/YeastEnrichr/geneSetLibrary?mode=text&libraryName=TF2DNA_2018", destfile = paste0(path,"publicData/TF2DNA_2018.txt"))
}
