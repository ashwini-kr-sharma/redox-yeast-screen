...
p_print = ggplot(hits, aes(x = Rank1, y = Median_roGFP2_ratio)) + theme_bw(base_size = 7) + 
          ...
          geom_text(data = hits[hits$Rank1 <= 10,], aes(x = 200, label = Genes), size=2) +
          geom_text(data = hits[hits$Rank2 <= 10,], aes(x = 200, label= Genes), size=2) 
...
This positive hit corresponds to 
